...
public class UI {
	...
	BufferedImage coin, heart_full, heart_half, heart_blank, crystal_full, crystal_blank;
...
//			currentDialogue = npc.dialogues[npc.dialogueSet][npc.dialogueIndex];
		...
		else {//if no tect is in the array
			npc.dialogueIndex = 0;
	...
	public void drawInventory(Entity entity, boolean cursor) {
		...
		if(entity == gp.player) { // FOR PLAYER
		...
		if(cursor == true) {
			...
			int cutsorWidth = gp.tileSize;
			int cursorHeight = gp.tileSize;
			
			// DRAW CURSOR
			g2.setColor(Color.white);
			g2.setStroke(new BasicStroke(3));
			g2.drawRoundRect(cursorX, cursorY, cutsorWidth, cursorHeight, 10, 10);
	...
	public void options_fullScreenNotification(int frameX, int frameY) {
		...
		currentDialogue = "Please restart your\ngame to apply it.";
	...
	public void options_control(int frameX, int frameY) {
		...
		g2.drawString("WADS", textX, textY); textY += gp.tileSize;
	...
	public void options_endGameConfirmation(int frameX, int frameY) {
		...
		currentDialogue = "Quit the game to\nthe title screen?";
