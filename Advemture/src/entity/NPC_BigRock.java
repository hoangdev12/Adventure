...
//		
//		ArrayList<ContactTile> plateList = new ArrayList<>();
//		ArrayList<Entity> rockList = new ArrayList<> ();
//		
//		//Creare a plate list
//		for(int i = 0; i < gp.cTile[1].length; i++) {
//			
//			if(gp.cTile[gp.currentMap][i] != null &&
//					gp.cTile[gp.currentMap][i].name != null &&
//					gp.cTile[gp.currentMap][i].name.equals(CT_MetalPlate.itName)) {
//				
//				plateList.add(gp.cTile[gp.currentMap][i]);
//			}
//		}
//		
//		//Create a rock list
