...
public class SaveLoad {
	...
	public void save() {
		...
		try {
			...
			ds.nextLevelDxp = gp.player.nextLevelExp;
	...
	public void load() {
		...
		try {
			...
			gp.player.nextLevelExp = ds.nextLevelDxp;
			...
			gp.player.currentWeapon = gp.player.inventory.get(ds.currentShieldSlot);
			gp.player.getAttack();
			...
			for(int mapNum = 0; mapNum < gp.maxMap; mapNum++) {
				...
				for(int i = 0; i < gp.obj[1].length; i++) {
					if(ds.mapObjectNames[mapNum][i].equals("NA") == true) {
